...
country.name = "Canada"     # The country name should match with the one in the 'coronavirus' R package
final.date = "2020-06-08"   # Final date of the data: "YYYY-MM-DD". Default is today
if (is.null(final.date)) final.date=Sys.Date()

Np = 3770000            # total population in US
min_cum_case = 100      # The first date of the analysis begins when the number of cumulative cases reaches 100
lockdown = "2020-03-13" # March 13th: lockdown measures began from public schools in Ontario and Quebeq
ghat = 1/18             # gamma
